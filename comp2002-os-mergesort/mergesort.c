...
void * parallel_mergesort(void *arg){
		/* We do not own 'arg' here; the creator is responsible for freeing it
		 * (see main() which frees the top-level arg). Child args created in this
		 * function are freed by the parent thread after join.
		 */
